# ----------------------------------------------------------- #
# ------------------- interactiveCalc.py -------------------- #
# --------- https://github.com/jhoormann/xxx --------- #
# ----------------------------------------------------------- #
# These are the functions used in interactiveLC.py.  Much of  #
# the light curve generation code is from                     #
...
# specifically for interactiveLC.py   There are a     #
# bunch of others dealing with widget functionality   #
# that are defined in the main code.                  #
# --------------------------------------------------- #
